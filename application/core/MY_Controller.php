...
class MY_Controller extends CI_Controller
{
	...
	public function tampilkan($halaman, $data = array()) {
		...
		$this->layout->add_includes('assets/css/font-awesome.min.css')
					 ...
					 ->add_includes('assets/js/plugin/FileSaver.min.js')
                     ->add_includes('assets/js/plugin/tableexport.min.js')
                     ->add_includes('assets/js/plugin/xls.core.min.js')
                     ->add_includes('assets/js/plugin/xlsx.core.min.js')
