<div class="container">
  ...
  <div class="field">
    <p class="control">
      <a href="switch/tambah" class="button is-link modal-button">Buat Switch Baru</a>
    </p>
  </div>
    ...
    <tbody>
      ...
      <?php foreach ($all_records as $data): ?>
        <tr>
          ...
          <td>
            <a id="btn-detail" class="button is-small is-info" target="<?php echo $data->kode_switch; ?>">Lihat Detil</a>
            <a id="btn-console" class="button is-small is-danger" data-target="modal-delete" target="<?php echo $data->kode_switch; ?>">Console</a>
            <a id="btn-hapus" class="button is-small is-danger modal-button" data-target="modal-delete" target="<?php echo $data->kode_switch; ?>">Hapus</a>
          </td>
        </tr>
      <?php endforeach; ?>
      <?php else: ?>
