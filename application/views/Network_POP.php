<div class="container">
  ...
  <script type="text/javascript">
    ...
    var map_action    = '<?php echo $action_map; ?>';
    ...
    function baru() {
      ...
      // show body
      body.load( "<?php echo base_url('manage/pop/tambah'); ?> #post-data" );
    }
    ...
    function detil(data) {
      ...
      // show body
      body.load( "<?php echo base_url('manage/pop/detail/'); ?>" + id + " #post-data" );
    }

    function map(data) {
      // action
      location = map_action + data;
    }
  ...
  <div class="field">
    <p class="control">
      ...
      <button type="button" class="button is-link">Network Map</button>
  ...
  <div class="field">
    <p class="control is-expanded">
      <input id="filter" class="input" type="text" name="filter" placeholder="Cari data POP disini..." autofocus="yes">
    </p>
  </div>
      ...
      <tbody>
        ...
        <?php foreach ($all_records as $data): ?>
          <tr>
            ...
            <td>
              <button type="button" class="button is-small is-link" data="<?php echo $data->kode_pop; ?>" onclick="detil($(this))">Lihat Detil</button>
              <button type="button" class="button is-small is-danger" data="<?php echo $data->kode_pop; ?>" onclick="hapus($(this))">Hapus</button>
            </td>
          </tr>
        <?php endforeach; ?>
        <?php else: ?>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    setInterval(function(){
      if (update) {
        $( "#data" ).load( "<?php echo base_url('manage/pop'); ?> #data-table" );
      }
